...
项目处于初步开发阶段，已具备有限体积网格、所属单元保守源投影、Maxwell 热浴平均相对速度，以及冻结 AGSS09 太阳背景和固定 MVP（`m_chi=0.1 GeV`、SD constant-contact、proton-only）的 63 靶逐靶/总直接散射率；条件热靶速度采样、三维单碰撞、输运求解器及物理验证尚未完成。
